...
const categoryAdditions = {
  disney: [
    "Pluto", "Daisy Duck", "Dagobert Duck", "Tick", "Trick", "Track", "Chip", "Chap", "Bambi",
    "Klopfer", "Blume", "Dumbo", "Timothy Maus", "Peter Pan", "Naseweis", "Wendy Darling",
    "Käpt'n Hook", "Smee", "Alice", "Verrückter Hutmacher", "Grinsekatze", "Herzkönigin", "Pinocchio",
    "Jiminy Grille", "Geppetto", "Schneewittchen", "Brummbär", "Seppl", "Pimpel", "Schlafmütz", "Hatschi",
    "Happy", "Chef", "Cinderella", "Prinz Charming", "Gute Fee", "Lady Tremaine", "Anastasia",
    "Drizella", "Aurora", "Maleficent", "Phillip", "Flora", "Fauna", "Merryweather", "Baloo",
    "Bagheera", "Mogli", "Shir Khan", "Kaa", "King Louie", "Robin Hood", "Little John",
    "Maid Marian", "Prinz John", "Winnie Puuh", "Tigger", "Ferkel", "I-Aah", "Rabbit", "Kanga",
    "Ruh", "Belle", "Biest", "Gaston", "Lumiere", "Von Unruh", "Madame Pottine", "Tassilo",
    ...
    "Freude", "Kummer", "Wut", "Angst", "Ekel", "Nemo", "Marlin", "Mike Glotzkowski", "Sulley"
  ],
  singers: [
